...
const faqItems = [
  {
    ...
    link: {
      text: "Learn more about why treating the wrong type of dark circles is the real problem.",
      href: "/blog/dark-circle-types-guide",
    },
  },
  {
    id: 2,
    ...
    link: {
      text: "See how it compares per-use to other popular eye treatments.",
      href: "/blog/awake-eye-complex-vs-the-ordinary-caffeine-solution",
    },
  },
  {
    id: 3,
    ...
    link: {
      text: "Check the complete ingredient list to verify for any personal allergens.",
      href: "/ingredients",
    },
  },
  {
    ...
    link: {
      text: "Find out which type of dark circles you have — it makes all the difference.",
      href: "/blog/dark-circle-types-guide",
    },
  },
  {
    ...
    link: {
      text: "See the full results timeline for each active ingredient.",
      href: "/science",
    },
  },
  {
    ...
    link: {
      text: "Read our full return policy.",
      href: "/refund",
    },
  },
];

// ✅ FAQ Schema - SEM links no texto (apenas o conteúdo original)
const faqSchema = {
...
export default function FAQ() {
  ...
  const formatAnswer = (answer: string, link?: { text: string; href: string }) => {
  ...
  const accordionItems = faqItems.map((item) => ({
    ...
    answer: formatAnswer(item.answer, item.link),
  }));
